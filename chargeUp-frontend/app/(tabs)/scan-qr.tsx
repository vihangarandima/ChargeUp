    ...
    <LinearGradient colors={['#0B1315', '#163B46', '#0B1315']} style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.content}>
          ...
          {/* 2. Control Row: Back Arrow and Bell Icon on the same line */}
          ...
          <View style={styles.qrCardWrapper}>
            {isScanning ? (
              <View style={styles.cameraContainer}>
                ...
                />
                {/* CANCEL BUTTON inside the camera view */}
...
const styles = StyleSheet.create({
  ...
  brandHeader: { marginTop: 10, marginBottom: 5 },
  brandTitle: { color: 'white', fontSize: 26, fontWeight: 'bold' },
