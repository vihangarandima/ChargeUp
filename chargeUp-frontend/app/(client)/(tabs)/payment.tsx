    ...
    <LinearGradient colors={['#0B1315', '#163B46', '#0B1315']} style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.content}>
          ...
          {/* Header Section - Arrow on left, Bell on right */}
          ...
          <View style={styles.card}>
            ...
            <TouchableOpacity style={styles.paymentMethodRow}>
              <View style={styles.rowLeft}>
                <View style={styles.visaBox}><Text style={styles.visaText}>VISA</Text></View>
                <Text style={styles.methodText}>HNB Credit Card -5525</Text>
              </View>
              <Ionicons name="chevron-forward" size={18} color="white" />
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  headerContainer: { marginBottom: 30, marginTop: 0 }, 
  brandTitle: { color: 'white', fontSize: 26, fontWeight: 'bold', marginBottom: 25, letterSpacing: 0.5 },
  ...
  visaBox: { backgroundColor: 'transparent', borderWidth: 1, borderColor: 'white', paddingHorizontal: 5, paddingVertical: 2, borderRadius: 4, marginRight: 15 },
